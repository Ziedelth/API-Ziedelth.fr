...
enum class GenreEnum(val fr: String, val identifiers: Array<String> = arrayOf()) {
    UNKNOWN("Inconnu"),
    ...
    WAR("Guerre", identifiers = arrayOf("War", "Guerre")),
    ...
    companion object {
         ...
         */
        fun getGenre(string: String): GenreEnum =
         ...
         */
        fun getGenres(array: Iterable<String>?): Array<GenreEnum> =
            array?.mapNotNull { s ->
                values().firstOrNull {
